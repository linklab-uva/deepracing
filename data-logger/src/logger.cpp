...
int main(int argc, char** argv) {
	...
	deepf1::simple_screen_listener screen_listener2(timer, capture_area_pov, application_name, image_len);
	...
	writeToFiles(data_directory, screen_data,screen_data2, udp_listener);
...
namespace deepf1 {
	...
	void writeToFiles(const std::string& dir,
		...
		for (auto it2 = screen_data2.begin(); it2 != screen_data2.end(); it2++) {
