...
#ifndef SOAP_TYPE_deepf1_gsoap_LONG64_DEFINED
#define SOAP_TYPE_deepf1_gsoap_LONG64_DEFINED
...
inline int soap_write_LONG64(struct soap *soap, LONG64 const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || deepf1_gsoap::soap_put_LONG64(soap, p, "long", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || deepf1_gsoap::soap_put_LONG64(soap, p, "long", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || deepf1_gsoap::soap_put_LONG64(soap, p, "long", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (p)
	{	if (soap_begin_recv(soap) || deepf1_gsoap::soap_get_LONG64(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || deepf1_gsoap::soap_read_LONG64(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (deepf1_gsoap::soap_read_LONG64(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
	...
	LONG64 timestamp)
{
	...
	{	_p->soap_default(soap);
		...
		_p->ground_truth_sample::timestamp = timestamp;
	}
	return _p;
}
