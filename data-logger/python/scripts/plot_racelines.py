...
ax.scatter(raceline_path[:,0], raceline_path[:,2], raceline_path[:,1], c=colors[0], marker=markers[0], s = np.ones_like(raceline_s))
ax.scatter(path[:,0], path[:,2], path[:,1], c=colors[1], marker=markers[1], s = np.ones_like(raceline_s))
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
