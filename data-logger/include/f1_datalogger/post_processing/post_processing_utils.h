...
namespace post_processing
{
	...
	public:
		...
		static std::pair<deepf1::protobuf::TimestampedUDPData, unsigned int> closestValue(const std::vector<deepf1::protobuf::TimestampedUDPData>& sorted_data, int64_t search);
