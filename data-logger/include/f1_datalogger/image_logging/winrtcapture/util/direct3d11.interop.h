...
inline auto F1_DATALOGGER_IMAGE_LOGGING_PUBLIC CreateDirect3DDevice(IDXGIDevice* dxgi_device)
{
...
inline auto F1_DATALOGGER_IMAGE_LOGGING_PUBLIC CreateDirect3DSurface(IDXGISurface* dxgi_surface)
{
