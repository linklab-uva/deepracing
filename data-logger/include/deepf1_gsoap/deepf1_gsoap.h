...
#ifndef SOAP_TYPE_deepf1_float_DEFINED
#define SOAP_TYPE_deepf1_float_DEFINED
...
inline int soap_write_float(struct soap *soap, float const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || deepf1::soap_put_float(soap, p, "float", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || deepf1::soap_put_float(soap, p, "float", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || deepf1::soap_put_float(soap, p, "float", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (p)
	{	if (soap_begin_recv(soap) || deepf1::soap_get_float(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || deepf1::soap_read_float(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (deepf1::soap_read_float(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif

#ifndef SOAP_TYPE_deepf1_std__string_DEFINED
#define SOAP_TYPE_deepf1_std__string_DEFINED
...
inline std::string * soap_new_req_std__string(
	struct soap *soap)
{
	std::string *_p = deepf1::soap_new_std__string(soap);
	if (_p)
	{	deepf1::soap_default_std__string(soap, _p);
	}
	return _p;
}
...
inline int soap_write_std__string(struct soap *soap, std::string const*p)
{
	soap_free_temp(soap);
	if (p)
	{	if (soap_begin_send(soap) || deepf1::soap_put_std__string(soap, p, "string", "") || soap_end_send(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || deepf1::soap_put_std__string(soap, p, "string", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || deepf1::soap_put_std__string(soap, p, "string", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (p)
	{	if (soap_begin_recv(soap) || deepf1::soap_get_std__string(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || deepf1::soap_read_std__string(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (deepf1::soap_read_std__string(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE_deepf1_ground_truth_label_DEFINED
#define SOAP_TYPE_deepf1_ground_truth_label_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ground_truth_label(struct soap*, struct ground_truth_label *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ground_truth_label(struct soap*, const struct ground_truth_label *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ground_truth_label(struct soap*, const char*, int, const struct ground_truth_label *, const char*);
SOAP_FMAC3 struct ground_truth_label * SOAP_FMAC4 soap_in_ground_truth_label(struct soap*, const char*, struct ground_truth_label *, const char*);
SOAP_FMAC1 struct ground_truth_label * SOAP_FMAC2 soap_instantiate_ground_truth_label(struct soap*, int, const char*, const char*, size_t*);

inline struct ground_truth_label * soap_new_ground_truth_label(struct soap *soap, int n = -1)
{
	return soap_instantiate_ground_truth_label(soap, n, NULL, NULL, NULL);
}

inline struct ground_truth_label * soap_new_req_ground_truth_label(
	struct soap *soap,
	...
	float m_brake)
{
	struct ground_truth_label *_p = deepf1::soap_new_ground_truth_label(soap);
	if (_p)
	{	deepf1::soap_default_ground_truth_label(soap, _p);
		_p->file_name = file_name;
		_p->m_throttle = m_throttle;
		_p->m_steer = m_steer;
		_p->m_brake = m_brake;
	}
	return _p;
...
inline struct ground_truth_label * soap_new_set_ground_truth_label(
	struct soap *soap,
	const std::string& file_name,
	float m_throttle,
	float m_steer,
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ground_truth_label(struct soap*, const struct ground_truth_label *, const char*, const char*);

inline int soap_write_ground_truth_label(struct soap *soap, struct ground_truth_label const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (deepf1::soap_serialize_ground_truth_label(soap, p), 0) || deepf1::soap_put_ground_truth_label(soap, p, "ground-truth-label", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ground_truth_label(struct soap *soap, const char *URL, struct ground_truth_label const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (deepf1::soap_serialize_ground_truth_label(soap, p), 0) || deepf1::soap_put_ground_truth_label(soap, p, "ground-truth-label", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_ground_truth_label(struct soap *soap, const char *URL, struct ground_truth_label const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (deepf1::soap_serialize_ground_truth_label(soap, p), 0) || deepf1::soap_put_ground_truth_label(soap, p, "ground-truth-label", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
SOAP_FMAC3 struct ground_truth_label * SOAP_FMAC4 soap_get_ground_truth_label(struct soap*, struct ground_truth_label *, const char*, const char*);

inline int soap_read_ground_truth_label(struct soap *soap, struct ground_truth_label *p)
{
	if (p)
	{	deepf1::soap_default_ground_truth_label(soap, p);
		if (soap_begin_recv(soap) || deepf1::soap_get_ground_truth_label(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ground_truth_label(struct soap *soap, const char *URL, struct ground_truth_label *p)
{
	if (soap_GET(soap, URL, NULL) || deepf1::soap_read_ground_truth_label(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_recv_ground_truth_label(struct soap *soap, struct ground_truth_label *p)
{
	if (deepf1::soap_read_ground_truth_label(soap, p) || soap_closesock(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
#endif
