...
class ExternalAgentCurvePredictor(nn.Module):
    def __init__(self, output_dim : int = 3, bezier_order : int = 3, input_dim : int = 10, hidden_dim : int = 500, num_layers : int = 1, dropout : float = 0.0, bidirectional : bool = True, learnable_initial_state : bool = False):
