...
def go():
    ...
    debug = config["debug"]
    control_loss_reduction = config["control_loss_reduction"]
    ...
    net = models.PilotNet(input_channels=input_channels, output_dim=3)
    ...
    for dataset in datasets:
        ...
        curent_dset = data_loading.proto_datasets.ControlOutputDataset(image_wrapper, label_wrapper, key_file, \
