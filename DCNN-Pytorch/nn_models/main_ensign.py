...
def main():
    ...
    im_scale = float(config.get('im_scale','255.0'))
    ...
    img_transformation = transforms.Compose([transforms.Lambda(lambda inputs: inputs.div(im_scale)), transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))])
    if(label_scale == 1.0):
