...
def go():
    ...
    print("Using config:\n%s" % (str(config)))
    net = deepracing_models.nn_models.Models.CNNLSTM( context_length = context_length , input_channels=input_channels, sequence_length=sequence_length,  hidden_dimension = hidden_dim ) 
    print("net:\n%s" % (str(net)))
